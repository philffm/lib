...
export async function FetchIPFS(cid) {
    ...
    try { var fetchresult=await FetchMultipleWithTimeout(urlarray,15000)    } catch(error) {console.log(error);}
...
let ipfsproviders=[ "https://ipfs.io/ipfs","https://ipfs.infura.io/ipfs","https://onderzoekjebuurt.nl/ipfs"];
