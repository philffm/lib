...
console.log(documentpart)
    ...
    cid=await MakeImage(ipfs, "Titan",documentpart); 	   list.push({name:"Titan",cid:cid} );
	cid=await MakeImage(ipfs, "Tutor",documentpart); 	   list.push({name:"Tutor",cid:cid} );
	cid=await MakeImage(ipfs, "Jedi",documentpart); 	  list.push({name:"Jedi",cid:cid} );
	cid=await MakeImage(ipfs, "Gaia",documentpart); 	  list.push({name:"Gaia",cid:cid} );
