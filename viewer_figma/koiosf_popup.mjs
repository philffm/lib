import {sleep,publish,subscribe,SelectTabBasedOnName,DomList,SelectTabBasedOnNumber,LinkClickButton,getElement} from '../lib/koiosf_util.mjs';
...
function GetAllTabs(areaid) {
    ...
    function CreateBlock(domid,id,name,icon) { 
...
//NOTE: Function does not seem to do anything 
//TODO: check where used and possibly remove
